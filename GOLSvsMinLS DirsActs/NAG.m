function [Xs,fh,err_tests,err_valids,run_count,run_alpha] = NAG(FUN,x,params,options)
...
while count<maxiter
    ...
    [err_train,err_test,err_valid,grad] = FUN(x00,params);
    ...
    F = @(x) FUN(x0 + gamma*v_t + x*direction,params);
    if grads == 0
